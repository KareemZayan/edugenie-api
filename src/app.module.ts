  ...
  imports: [
    ...
    ConfigModule.forRoot({
      ...
      validationSchema: Joi.object({
        ...
        OPEN_AI_MODEL: Joi.string().allow('').optional(),
        OPEN_AI_TRANSCRIBE_MODEL: Joi.string().allow('').optional(),
        ...
        // falls back to in-Node automatically if a vector query errors.
        RAG_USE_VECTOR_SEARCH: Joi.boolean()
          .truthy('true')
          .falsy('false')
          .default(false),
        NODE_ENV: Joi.string()
